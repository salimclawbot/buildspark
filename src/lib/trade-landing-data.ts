...
export const tradeConfigs: Record<TradeKey, {
  ...
  plumber: {
    ...
    seoDescription: "Get a professional website for your plumbing business for $250 per month. Compare Melbourne plumbers. Free preview.",
  ...
  electrician: {
    ...
    seoDescription: "Get a professional website for your electrical business for $250 per month. Compare Melbourne electricians. Free preview.",
  ...
  painter: {
    ...
    seoDescription: "Get a professional website for your painting business for $250 per month. Compare Melbourne painters. Free preview.",
  ...
  builder: {
    ...
    seoDescription: "Get a professional website for your building business for $250 per month. Compare Melbourne builders. Free preview.",
  ...
  bookkeeper: {
    ...
    seoDescription: "Get a professional website for your bookkeeping business for $250 per month. Compare Melbourne bookkeepers. Free preview.",
